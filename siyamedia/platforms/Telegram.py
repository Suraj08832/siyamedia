...
from siyamedia.utils.formatters import (
    check_duration,
    convert_bytes,
    get_readable_time,
    seconds_to_min,
        ...
        async def down_load():
            async def progress(current, total):
                ...
                upl = InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="??????", callback_data="stop_downloading")]]
                )
                ...
                eta = get_readable_time(eta_s) or "0 s?????s"
