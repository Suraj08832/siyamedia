...
BUTTON = InlineKeyboardMarkup([[InlineKeyboardButton("???????", url=SUPPORT_CHAT)]])
...
TEMPLATES = {
    "cutie": "?? {mention} ?? {percent}% ???? ??????",
    "horny": "?? {mention} ?? {percent}% ?????!",
    "hot": "?? {mention} ?? {percent}% ???!",
    "sexy": "?? {mention} ?? {percent}% ??x?!",
    "gay": "?? {mention} ?? {percent}% ???!",
    "lesbian": "?? {mention} ?? {percent}% ???????!",
    "boob": "?? {mention}? ???? ???? ?? {percent}!",
    "cock": "?? {mention} ???? ???? ?? {percent}??!",
}
